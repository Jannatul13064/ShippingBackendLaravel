...
@endif
      ...
      <form class="p-4 custom_form" method="POST" action="{{route('admin.create-booking')}}">
            @csrf
            ...
            <div>
                ...
                <div class="w-2/3">
                    ...
                    <option>--Select Freight Term--</option>
                ...
                <div class="w-2/3">
                    ...
                    <option hidden>--Select Shipper Bank--</option>
                ...
                <div class="flex gap-4 items-start mb-4">
                    ...
                    <div class="w-2/3">
                        <textarea placeholder="Enter Agent Address" name="agent_address"></textarea>
                    </div>
                    </div>
                <div class="flex gap-4 items-start mb-4">
                    <label class="w-1/3 text-end">
                    ...
                    <div class="w-2/3">
                        <textarea placeholder="Enter Agent Address" name="agent_emergency_address"></textarea>
                    </div>
                </div>
                ...
                <div class="flex gap-4 items-start mb-4">
                    ...
                    <div class="w-2/3">
                        <textarea placeholder="Enter Consignee Address" name="consignee_address"></textarea>
                    </div>
                </div>
                ...
                <div class="w-2/3">
                    ...
                    <option>--Consignee Account-type--</option>
            ...
            <div>
                ...
                <div class="w-2/3">
                    ...
                    <option hidden>--Select Sales Person--</option>
            ...
            <table class="w-full text-sm text-left border narrowTable">
                ...
                <tr class="border-b">
                    ...
                    <td class="w-28">
                    <input type="text" placeholder="S/O" name="so"/>
                    </td>
                    <td class="w-28">
                    <input type="text" placeholder="Carton" name="cartoon"/>
                    </td>
                    <td>
                        <input type="text" placeholder="Package" name="package"/>
                    </td>
                    <td class="w-28">
                    <input type="text" placeholder="Pieces" name="piece" />
                    </td>
                    <td class="w-28">
                    ...
                    <td class="w-28">
                    <input type="text" placeholder="CBM" name="chargeable_weight" disabled/>
                    </td>

                    <td class="w-28">
                    <input type="text" placeholder="GWT" name="gwt"/>
                    </td>
                    <td class="w-28">
                    <input type="text" placeholder="MWT" name="mwt"/>
                    </td>
