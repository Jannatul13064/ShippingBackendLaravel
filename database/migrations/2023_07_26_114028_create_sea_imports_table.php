...
return new class extends Migration
{
    ...
    {
        Schema::create('seaImports', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('commodity_type',['general','perishable','danger','oversized']);
  ...
  Indexes {
    ...
    {
        Schema::dropIfExists('seaImports');
    }
};
